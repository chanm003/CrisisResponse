...
(function () {
  ...
  /** @ngInject */
  function baSidebar($timeout, baSidebarService, baUtil, commonConfig, layoutSizes) {
    var jqWindow = $(window);
    return {
      restrict: 'E',
      templateUrl: commonConfig.settings.baseUrl + '/src/app/theme/components/baSidebar/ba-sidebar.html',
